export class Config {
  //KINVEY
  static appKey: any = "kid_BJjcg48nm";
  static appSecret: any = "b4dce4c02b99452691a9d3b1a0073ca7";

  //LOGIN
  static appLogo: string = "images/logo-6.png";
  static appTitle: string = "";

  //HOME
  static homePageTitle: string = "Home";
  static logo: string = "https://www.ekyros.com/Pub/images/ek-logo391x100.png";
  static homePageVisible: boolean = true;
  static homePageHeading: string = "We got your backend...";

  //ACCOUNTS
  static accountsPageTitle: string = "Hospitals";
  static accountsCollectionName: string = "hospitals";
